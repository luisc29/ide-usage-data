...
%		\includegraphics[width=\linewidth,clip=, angle=0]{Figures/UDC_inte_emin}  
%		\endminipage\hfill
%		\minipage{0.33\textwidth}
%		\includegraphics[width=\linewidth,clip=, angle=0]{Figures/UDC_inte_smin}  
%		\endminipage\hfill
%		\minipage{0.33\textwidth}
%		\includegraphics[width=\linewidth,clip=, angle=0]{Figures/UDC_inte_eratio} 
%		\endminipage\hfill
%	\end{tabular}
...
\subsection{Comparison of working sessions patterns}
